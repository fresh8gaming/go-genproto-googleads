...
func (x *DynamicLocationSetFilter) Reset() {
	*x = DynamicLocationSetFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes[0]
...
func (*DynamicLocationSetFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescGZIP(), []int{0}
}
...
func (x *BusinessNameFilter) Reset() {
	*x = BusinessNameFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BusinessNameFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescGZIP(), []int{1}
}
...
func (x *DynamicAffiliateLocationSetFilter) Reset() {
	*x = DynamicAffiliateLocationSetFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DynamicAffiliateLocationSetFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescData = file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDesc
)

func file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescData)
	})
	return file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDescData
}

var file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_init() }
func file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_init() {
	if File_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto = out.File
	file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_rawDesc = nil
	file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_goTypes = nil
	file_google_ads_googleads_v11_common_feed_item_set_filter_type_infos_proto_depIdxs = nil
}
