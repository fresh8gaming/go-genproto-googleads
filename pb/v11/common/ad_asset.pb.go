...
func (x *AdTextAsset) Reset() {
	*x = AdTextAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[0]
...
func (*AdTextAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_ad_asset_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdImageAsset) Reset() {
	*x = AdImageAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdImageAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_ad_asset_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdVideoAsset) Reset() {
	*x = AdVideoAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdVideoAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_ad_asset_proto_rawDescGZIP(), []int{2}
}
...
func (x *AdMediaBundleAsset) Reset() {
	*x = AdMediaBundleAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdMediaBundleAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_ad_asset_proto_rawDescGZIP(), []int{3}
}
...
func (x *AdDiscoveryCarouselCardAsset) Reset() {
	*x = AdDiscoveryCarouselCardAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdDiscoveryCarouselCardAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_common_ad_asset_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v11_common_ad_asset_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v11_common_ad_asset_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v11_common_ad_asset_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v11_common_ad_asset_proto_rawDescData = file_google_ads_googleads_v11_common_ad_asset_proto_rawDesc
)

func file_google_ads_googleads_v11_common_ad_asset_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v11_common_ad_asset_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v11_common_ad_asset_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v11_common_ad_asset_proto_rawDescData)
	})
	return file_google_ads_googleads_v11_common_ad_asset_proto_rawDescData
}

var file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v11_common_ad_asset_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v11_common_ad_asset_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v11_common_ad_asset_proto_init() }
func file_google_ads_googleads_v11_common_ad_asset_proto_init() {
	if File_google_ads_googleads_v11_common_ad_asset_proto != nil {
		return
	}
	file_google_ads_googleads_v11_common_asset_policy_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v11_common_ad_asset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v11_common_ad_asset_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v11_common_ad_asset_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v11_common_ad_asset_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v11_common_ad_asset_proto = out.File
	file_google_ads_googleads_v11_common_ad_asset_proto_rawDesc = nil
	file_google_ads_googleads_v11_common_ad_asset_proto_goTypes = nil
	file_google_ads_googleads_v11_common_ad_asset_proto_depIdxs = nil
}
