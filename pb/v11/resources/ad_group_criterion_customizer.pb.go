...
func (x *AdGroupCriterionCustomizer) Reset() {
	*x = AdGroupCriterionCustomizer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_msgTypes[0]
...
func (*AdGroupCriterionCustomizer) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescData = file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDesc
)

func file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescData)
	})
	return file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDescData
}

var file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_init() }
func file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_init() {
	if File_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto = out.File
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_rawDesc = nil
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_goTypes = nil
	file_google_ads_googleads_v11_resources_ad_group_criterion_customizer_proto_depIdxs = nil
}
