...
func (SlotEnum_Slot) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v10_enums_slot_proto_enumTypes[0].Descriptor()
}

func (SlotEnum_Slot) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v10_enums_slot_proto_enumTypes[0]
}
...
func (SlotEnum_Slot) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_enums_slot_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SlotEnum) Reset() {
	*x = SlotEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_enums_slot_proto_msgTypes[0]
...
func (*SlotEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_enums_slot_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v10_enums_slot_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v10_enums_slot_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x30, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xae, 0x01, 0x0a, 0x08,
...
var (
	file_google_ads_googleads_v10_enums_slot_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_enums_slot_proto_rawDescData = file_google_ads_googleads_v10_enums_slot_proto_rawDesc
)

func file_google_ads_googleads_v10_enums_slot_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_enums_slot_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_enums_slot_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_enums_slot_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_enums_slot_proto_rawDescData
}

var file_google_ads_googleads_v10_enums_slot_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v10_enums_slot_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v10_enums_slot_proto_goTypes = []interface{}{
	(SlotEnum_Slot)(0), // 0: google.ads.googleads.v10.enums.SlotEnum.Slot
	(*SlotEnum)(nil),   // 1: google.ads.googleads.v10.enums.SlotEnum
}
var file_google_ads_googleads_v10_enums_slot_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v10_enums_slot_proto_init() }
func file_google_ads_googleads_v10_enums_slot_proto_init() {
	if File_google_ads_googleads_v10_enums_slot_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_enums_slot_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_enums_slot_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v10_enums_slot_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_enums_slot_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v10_enums_slot_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v10_enums_slot_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_enums_slot_proto = out.File
	file_google_ads_googleads_v10_enums_slot_proto_rawDesc = nil
	file_google_ads_googleads_v10_enums_slot_proto_goTypes = nil
	file_google_ads_googleads_v10_enums_slot_proto_depIdxs = nil
}
