...
func (x *RegenerateShareableLinkIdRequest) Reset() {
	*x = RegenerateShareableLinkIdRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_msgTypes[0]
...
func (*RegenerateShareableLinkIdRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegenerateShareableLinkIdResponse) Reset() {
	*x = RegenerateShareableLinkIdResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RegenerateShareableLinkIdResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescGZIP(), []int{1}
}

var File_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescData = file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_goTypes = []interface{}{
...
var file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_depIdxs = []int32{
...
func init() {
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_init()
}
func file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_init() {
	if File_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto = out.File
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_third_party_app_analytics_link_service_proto_depIdxs = nil
}
