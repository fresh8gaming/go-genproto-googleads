...
func (x *MutateCampaignGroupsRequest) Reset() {
	*x = MutateCampaignGroupsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[0]
...
func (*MutateCampaignGroupsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignGroupOperation) Reset() {
	*x = CampaignGroupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignGroupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignGroupsResponse) Reset() {
	*x = MutateCampaignGroupsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignGroupsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignGroupResult) Reset() {
	*x = MutateCampaignGroupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignGroupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v10_services_campaign_group_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x43, 0x61, 0x6d, 0x70,
	0x61, 0x69, 0x67, 0x6e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x58, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x39, 0x22, 0x34, 0x2f, 0x76, 0x31, 0x30,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x31, 0x30, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x19, 0x43,
...
var (
	file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescData = file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDesc
)

func file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDescData
}

var file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v10_services_campaign_group_service_proto_goTypes = []interface{}{
	(*MutateCampaignGroupsRequest)(nil),                    // 0: google.ads.googleads.v10.services.MutateCampaignGroupsRequest
	(*CampaignGroupOperation)(nil),                         // 1: google.ads.googleads.v10.services.CampaignGroupOperation
	(*MutateCampaignGroupsResponse)(nil),                   // 2: google.ads.googleads.v10.services.MutateCampaignGroupsResponse
	(*MutateCampaignGroupResult)(nil),                      // 3: google.ads.googleads.v10.services.MutateCampaignGroupResult
	...
	(*resources.CampaignGroup)(nil),                        // 6: google.ads.googleads.v10.resources.CampaignGroup
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v10_services_campaign_group_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v10.services.MutateCampaignGroupsRequest.operations:type_name -> google.ads.googleads.v10.services.CampaignGroupOperation
	4, // 1: google.ads.googleads.v10.services.MutateCampaignGroupsRequest.response_content_type:type_name -> google.ads.googleads.v10.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v10.services.CampaignGroupOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v10.services.CampaignGroupOperation.create:type_name -> google.ads.googleads.v10.resources.CampaignGroup
	6, // 4: google.ads.googleads.v10.services.CampaignGroupOperation.update:type_name -> google.ads.googleads.v10.resources.CampaignGroup
	3, // 5: google.ads.googleads.v10.services.MutateCampaignGroupsResponse.results:type_name -> google.ads.googleads.v10.services.MutateCampaignGroupResult
	7, // 6: google.ads.googleads.v10.services.MutateCampaignGroupsResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v10.services.MutateCampaignGroupResult.campaign_group:type_name -> google.ads.googleads.v10.resources.CampaignGroup
	0, // 8: google.ads.googleads.v10.services.CampaignGroupService.MutateCampaignGroups:input_type -> google.ads.googleads.v10.services.MutateCampaignGroupsRequest
	2, // 9: google.ads.googleads.v10.services.CampaignGroupService.MutateCampaignGroups:output_type -> google.ads.googleads.v10.services.MutateCampaignGroupsResponse
...
func init() { file_google_ads_googleads_v10_services_campaign_group_service_proto_init() }
func file_google_ads_googleads_v10_services_campaign_group_service_proto_init() {
	if File_google_ads_googleads_v10_services_campaign_group_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v10_services_campaign_group_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v10_services_campaign_group_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v10_services_campaign_group_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v10_services_campaign_group_service_proto = out.File
	file_google_ads_googleads_v10_services_campaign_group_service_proto_rawDesc = nil
	file_google_ads_googleads_v10_services_campaign_group_service_proto_goTypes = nil
	file_google_ads_googleads_v10_services_campaign_group_service_proto_depIdxs = nil
}
...
// UnimplementedCampaignGroupServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedCampaignGroupServiceServer) MutateCampaignGroups(context.Context, *MutateCampaignGroupsRequest) (*MutateCampaignGroupsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateCampaignGroups not implemented")
}
